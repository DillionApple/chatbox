            ...
            <DialogContent>
                ...
                <Stack spacing={2} direction="row" sx={{ justifyContent: 'center', marginTop: '10px' }}>
                    <Badge color="primary" variant="dot" invisible={false}>
                        <Button
                            variant="outlined"
                            onClick={() =>
                                runtime.openLink(`https://chatboxai.app/redirect_app/check_update/${props.lang}`)
                            }
                        >
                            {t('Check Update')}
                        </Button>
                    ...
                    <Button
                        variant="outlined"
                        onClick={() => runtime.openLink(`https://chatboxai.app/redirect_app/homepage/${props.lang}`)}
                    >
                        {t('Homepage')}
                    </Button>
                    <Button
                        variant="outlined"
                        onClick={() => runtime.openLink(`https://chatboxai.app/redirect_app/feedback/${props.lang}`)}
                    >
                        {t('Feedback')}
                    </Button>
                    <Button
                        variant="outlined"
                        onClick={() => runtime.openLink(`https://chatboxai.app/redirect_app/roadmap/${props.lang}`)}
                    >
                        {t('Roadmap')}
                    </Button>
                </Stack>
                ...
                >
                    ...
                    <Stack spacing={2} direction="row">
                        <Button
                            variant="text"
                            onClick={() => runtime.openLink(`https://chatboxai.app/redirect_app/donate/${props.lang}`)}
                        >
                            {t('Donate')}
                        </Button>
                        <Button
                            variant="text"
                            onClick={() =>
                                runtime.openLink(`https://chatboxai.app/redirect_app/become_sponsor/${props.lang}`)
                            }
                        >
